            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
                <div className="col-span-1 md:col-span-2">
                    <Link to="/" className="flex items-center gap-2 mb-8 group">
                        <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center text-black group-hover:scale-105 transition-transform">
                           <Rocket className="w-5 h-5" />
                        </div>
                        <span className="text-2xl font-black text-white tracking-tighter font-outfit uppercase italic">IT_27</span>
                    </Link>
                ...
                <div>
                    <h4 className="text-white font-black font-outfit uppercase tracking-[0.2em] text-xs mb-8">Support</h4>
                    <ul className="space-y-4">
